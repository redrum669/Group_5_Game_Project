...
// `scale` selects the on-screen sprite size: 2 â†?16x16 px (1 px/bit, safe
// zones), 3 â†?24x24 px (1.5 px/bit via offset table, combat zones). Sprite is
// centred on its 16x16 tile anchor (`px`,`py`) â€?at scale 3 it extends 4 px
// past each edge.
