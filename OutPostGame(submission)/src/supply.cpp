...
const int SUPPLY_MERCHANT_X  = 6;
const int SUPPLY_MERCHANT_Y  = 5;
const int SUPPLY_SCOUT_X     = 2;
const int SUPPLY_SCOUT_Y     = 5;
const int SUPPLY_CIVILIAN_X  = 10;
const int SUPPLY_CIVILIAN_Y  = 5;
const int SUPPLY_WIZARD_X    = 10;
const int SUPPLY_WIZARD_Y    = 8;

void drawLantern(int px, int py) {
...
void drawMarketRug(int px, int py, uint16_t mainColor, uint16_t trimColor) {
...
void drawCratePile(int px, int py, bool tall) {
...
void drawTradeHallTop(int px, int py, int tx) {
...
void drawTradeHallBody(int px, int py, bool leftEdge, bool rightEdge) {
...
void drawTradeCounter(int px, int py, bool leftEdge, bool rightEdge) {
...
void drawSideStall(int px, int py, bool leftSide, bool lowerTile) {
    ...
    if (!lowerTile) {
        ...
        if (leftSide)
            lcd.drawText(px + 4, py + 10, "K", COLOR_YELLOW, wood, 1);
        else
            lcd.drawText(px + 4, py + 10, "S", COLOR_YELLOW, wood, 1);
    } else {
