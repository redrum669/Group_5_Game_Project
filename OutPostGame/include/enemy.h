...
#define KNIFE_MOVE_PX    1    // pixels per frame while interpolating (16 px = 8 frames ≈ 130 ms)
...
#define HEAVY_MOVE_PX    1    // slow brute: 16 frames ≈ 260 ms / tile
#define HEAVY_ATK_MS     1200
#define HEAVY_DMG        25

// Player smooth-movement speed
#define PLAYER_MOVE_PX   3    // ~6 frames / tile ≈ 100 ms
